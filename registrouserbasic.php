        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="insertaruser.php" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fname" placeholder="Ingrese el nombre" required="" name="nombre">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Apellidos</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="lname" placeholder="Ingrese los apellidos"required="" name="apellidos">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="email1" placeholder="Correlativo de empleado UEES" required="" name="correl">
                                        </div>
                                    </div>
                                    <div class="form-group row">
...
<?php include("conexion.php"); $link=conecta(); $queryselect=mysqli_query($link,"SELECT DISTINCT idrol,descripcion FROM rol");
