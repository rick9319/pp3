...
$resultb=mysqli_query($link,"SELECT idusuario, nombre,apellidos,correl,idrol,nombreusuario, correo, password, fotor,fechar FROM registro where nombre LIKE '%$nombre%' AND apellidos LIKE '%$apellidos%' AND correl LIKE '%$correl%' AND nombreusuario LIKE '%$nombreusuario%' ");
...
<td><?php echo"<a href ='deluser.php?idusuario=$id'><center><i class='fas fa-eraser'></i>Eliminar</a></center>";?>
</td>
</tr>
</tbody>
<?php
