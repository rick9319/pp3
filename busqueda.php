...
$resultb=mysqli_query($link,"SELECT idusuario, nombre,apellidos,correl,idrol,nombreusuario, correo, password,fechar FROM registro where nombre LIKE '%$nombre%' AND apellidos LIKE '%$apellidos%' AND correl LIKE '%$correl%' AND nombreusuario LIKE '%$nombreusuario%' ");
