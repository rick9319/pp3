            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Consulta de salidas (asignaciones)</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="bienvenido.php">Inicio</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Consulta salidas</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                         <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Consulta de equipos</h5>
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        <thead>
                                        <?php
      
$mixedquery=mysqli_query($link,"SELECT procesoasig.idasig,registro.nombreusuario, registro.correl, equipo.marca, equipo.modelo, equipo.nserie,aula.aula,procesoasig.cantidad,procesoasig.fechaasig,procesoasig.aprob from (((procesoasig INNER JOIN registro ON registro.idusuario=procesoasig.idusuario) INNER JOIN equipo ON equipo.idequipo=procesoasig.idequipo) INNER JOIN aula ON aula.idaula=procesoasig.idaula)");
        ?>
           
            <tr align='center'>
<th>Usuario que asigna</th>
<th>Correlativo de usuario</th>
<th>Marca del equipo</th>
<th>Modelo</th>
<th>Numero de Serie</th>
<th>Aula de asignacion</th>
...
<td align="center"> <?php echo $rowmix[1]?> </td>

 <td align="center"><?php echo $rowmix[2]?> </td>
<td align="center"><?php echo $rowmix[3]?> </td>
<td align="center"> <?php echo $rowmix[4]?> </td>
<td align="center"> <?php echo $rowmix[5]?> </td>
 <td align="center"> <?php echo $rowmix[6]?> </td>
             <td align="center"> <?php echo $rowmix[7]?></td>
            <td align="center"><?php echo $rowmix[8]?> </td>
    <td align="center"><?php
    if (($rowmix[9]) == 0){
        $estado0='Solicitud no aprobada';
    }
    else if (($rowmix[9]) == 1){
        $estado0='Solicitud aprobada';
    }
      else {
        $estado0='Solicitud pendiente';
    }
echo $estado0;

       ?> </td>
        
   <td><?php echo"<a href ='formprobh.php?idasig=$idasig'><center><i class='fas far fa-newspaper'></i>Formulario</a></center>"; ?></td>
<td><?php echo"<a href ='editaasig.php?idasig=$idasig'><center><i class='fas fa-edit'></i>Editar</a></center>"; ?></td>

<td><?php echo"<a href ='delasig.php?idasig=$idasig'><center><i class='fas fa-eraser'></i>Eliminar</a></center>";?>
</td>
</tr>
</tbody>
<?php
