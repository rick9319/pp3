            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                      <div class="card">
                            <div class="card-body">
                                <h2 class="card-title" align="center">Sistema de Entrada y Salidas - SES</h2>
                                <br>
                                <p align="justify">El Sistema de Entradas y Salidas está enfocado en el control de  entrada y salida de equipos tecnológicos asignados a aulas de la facultad de ingeniería, así como también un listado de aulas disponibles y con una función que nos permitirá  añadir más aulas para su uso. Para mantener un registro de los horarios en el cual estas aulas estarán utilizando el equipo, también el sistema cuenta con una encuesta de satisfacción de préstamos de equipo y puntualidad a la hora de ser proveídos. El sistema también con un amplio espacio para observar categorías de mobiliario, así también con una forma eficiente de registrar nuevos equipos. Se cuenta también con un calendario de eventos para agenda eventos en los cuales se necesite disponer de muchos equipos. Mencionar también que se cuenta con un sistema de importación y exportación de datos para facilitar el proceso de envió de información. Para finalizar el sistema cuenta con una firma electrónica a la hora de solicitar mobiliario para tener control del responsable que lo solicita. </p>
                            </div>
                        </div>
                    </div>
           <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                 <h2 class="card-title" align="center">Desarrolladores</h2>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title" align="center">Ricardo Angel Gallegos Sanchez</h5>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title" align="center">Luis Mario Regalado Villalta</h5>                            
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title" align="center">Alisson Lissete Avalos</h5>                 
                            </div>
                        </div>
                    </div>
