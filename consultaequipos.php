                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item search-box"> <a class="nav-link waves-effect waves-dark" href="javascript:void(0)"><i class="ti-search"></i></a>
                          ...
                          <table bgcolor="white">
                                <tr><input type="text" class="form-control" placeholder="Buscar equipos" name="search"> <a class="srh-btn"><i class="ti-close"></i></a></tr>
...
<input value="correlativo" name="correlativo" type="checkbox" size="50"><font color="#0e144d">Correlativo</font>
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Consulta equipos</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        include("conexion.php");
            $link=conecta();
            $resulteq=mysqli_query($link,"SELECT idequipo, idtipo, idusuario, marca, modelo , nserie, cantidad, fechre FROM equipo");
...
<?php  
while($row = mysqli_fetch_row($resulteq))
 {
$id = $row[0];
?>  
<tbody>
...
<td style="display:none;"> <?php echo $row[0]?> </td>
  <?php
$resulttipo=mysqli_query($link,"SELECT idtipo,nombre FROM tipo");
while($rowtipo = mysqli_fetch_row($resulttipo))
{
if($row[1] == $rowtipo[0]){
?>   <td><?php echo $rowtipo[1]?> </td>
...
?>
 <?php
$resultid=mysqli_query($link,"SELECT idusuario,nombreusuario FROM registro");
