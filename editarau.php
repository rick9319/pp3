...
$result = mysqli_query($link, "SELECT aula FROM aula WHERE idaula=$id");
                    ...
                    <!-- ============================================================== -->
                       <ul class="navbar-nav float-left mr-auto">
                        <li class="nav-item d-none d-md-block"><a class="nav-link sidebartoggler waves-effect waves-light" href="javascript:void(0)" data-sidebartype="mini-sidebar"><i class="mdi mdi-menu font-24"></i></a></li>
                         <li class="nav-item d-none d-md-block"> <a class="nav-link waves-effect waves-dark" href="consultaraula.php"><i class="mdi mdi-arrow-left-bold font-24"></i></a>
        ...
        <div class="page-wrapper">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="consultaraula.php">Consulta aulas</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="actualizarau.php" method="post">
                                <div class="card-body">
                                    <h4 class="card-title">Editar información del aula : <?php echo $nombre ?></h4>
