            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="estadisticas.php" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">Estadisticas</span></a></li>
                          ...
                          <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-blur-linear"></i></i><span class="hide-menu">Aulas </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                ...
                                <li class="sidebar-item"><a href="registrouserbasic.php" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu"> Asignar </span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="encuesta.php" aria-expanded="false"><i class="mdi mdi-script"></i><span class="hide-menu">Encuesta</span></a></li>
                        </li>
                        ...
                        <div class="card">
                                 <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><br>Exportar Usuarios</button>
                                     ...
                                     <h4 class="card-title">Exportar Datos (EXCEL)</h4>
                                       <div class="form-group row">
                                    <button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><br>Exportar Usuarios</button>
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="#">Exportar administradores</a>
                                            <a class="dropdown-item" href="#">Exportar tecnicos</a>
                                             <a class="dropdown-item" href="#">Exportar clientes</a>
                                                                          </div>
                                         <div>
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="#">Exportar tecnicos</a>
                                             <a class="dropdown-item" href="#">Exportar clientes</a>
                                                                             ...
                                                                             <div>
                                                                              <button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="mdi mdi-hospital-building"></i><br>Exportar Aulas</button>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="usuariospdf.php">Exportar todos</a>
                                            <a class="dropdown-item" href="#">Exportar administradores</a>
                                            <a class="dropdown-item" href="#">Exportar tecnicos</a>
                                        ...
                                        <div>
                                         <button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="mdi mdi-loupe"></i><br>Exportar Categorias</button>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="usuariospdf.php">Exportar todos</a>
                                            <a class="dropdown-item" href="#">Exportar administradores</a>
                                            <a class="dropdown-item" href="#">Exportar tecnicos</a>
