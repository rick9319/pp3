                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Consulta aulas</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                         <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Consulta de aulas</h5>
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        <thead>
                                        <?php
      
            $result=mysqli_query($link,"SELECT * FROM aula");
...
<td><?php echo"<a href ='editarau.php?idau=$id'><center><i class='fas fa-edit'></i>Editar</a></center>"; ?></td>

<td><?php echo"<a href ='delau.php?idau=$id'><center><i class='fas fa-eraser'></i>Eliminar</a></center>";?>
</td>
</tr>
</tbody>
<?php
