        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="excelinv2.php" method="post">
                                <div class="card-body">
                                    <h4 class="card-title">Reporte por nombre de usuario</h4>
                                    
                                       <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Nombre</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="email1" placeholder="Ingrese el nombre de usuario" name="nombre">
                                        </div>
                                    </div>
