...
$fecha1=$_POST['date1'] ;
$fecha2=$_POST['date2'] ;
$queEmp=mysqli_query($link2, "SELECT * FROM procesoasig WHERE fechaasig >='$fecha1' AND fechaasig <='$fecha2 23:59:59'");
...
$header = array('ID Asignacion', 'ID Equipo', 'ID Aula', 'ID Usuario','Cantidad','Fecha de registro','Estado');
