        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                           <form name="upload_excel" method="post" action="importar_usuarios_temporal_csv.php" enctype="multipart/form-data" >
                                <div class="card-body">
                                    <h4 class="card-title">Seleccione archivo</h4>
                                    <br>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Importar usuarios</label>
                                        <div class="col-sm-9">
                                            <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="validatedCustomFile" accept=".csv" name="file">
                                            <label class="custom-file-label" for="validatedCustomFile">Seleccione  el archivo</label>
                                         <div class="control-group">
                                            <div class="controls">
                                             <button type="submit" id="submit" name="Import" value="Import" class="btn btn-primary button-loading" data-loading-text="Loading...">Subir Archivo</button>
                                            </div>
                                            </div>
...
div.scrolled {
  ...
  overflow: scroll;
        ...
        <a href="importar_usuarios_confirmar_csv.php">
        <input type="submit" value="confirmar" class="btn btn-info" name="Confirmar">
     </a></p>
          <table id="zero_config" class="table table-striped table-bordered">
            <thead>
                    <tr>
                        ...
                        <th width="5%">correl</th>
                        <th width="5%">idrol</th>
                        <th width="10%">Nombre_Usuario</th>
                ...
                $SQLSELECT = "SELECT * FROM temps_registro";
