            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Solicitud de aprobacion</h4>
    ...
    while($rowmix = mysqli_fetch_row($mixedquery))
{
    ...
    $aprob=$rowmix[10];}
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Universidad Evangelica de El Salvador: </h5>
                                <p>Yo <?php echo $nombre; ?> <?php echo $apellidos;?> con correlativo n° <?php echo $correl ?> empleado/a natural de la Universidad Evangelica de El Salvador solicito aprobacion para realizar la asignacion del siguiente equipo: </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p> Marca del equipo: <?php echo $marca;?></p>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p> Cantidad a asignar : <?php echo $cantidad;?> unidad/es</p>
                                <p> Fecha de solicitud en sistema : <?php echo $fecha;?></p>
                            </div>
                        </div>
                    </div>
                          <div class="col-12">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-title">Firma decanato</h6>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body"> 
                                <br>
                                      <p><?php
                                $image_list = glob("./signatures/$idusuario*.png");
                                ...
                                ?></p>
                                <h6 class="card-title">Firma solicitante</h6>
 ...
 <div class="border-top">
                                    <div class="card-body">
                                     <?php echo "<button class='btn btn-danger'> <a href='formaprob.php?idasig=$id' style='color:white'>Exportar PDF</a> </button";?>
