...
<body>
 ...
 <header class="topbar" data-navbarbg="skin5">
        ...
        <div class="page-wrapper">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Consulta categorias</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            $result=mysqli_query($link,"SELECT * FROM tipo");
...
<td><?php echo"<a href ='editarcat.php?idtipo=$id'><center><i class='fas fa-edit'></i>Editar</a></center>"; ?></td>

<td><?php echo"<a href ='delcat.php?idtipo=$id'><center><i class='fas fa-eraser'></i>Eliminar</a></center>";?>
</td>
</tr>
</tbody>
<?php
