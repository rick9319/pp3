...
$rol=$_POST['rol']; 
$result=mysqli_query($link, "UPDATE registro  SET nombre='$nombre', apellidos='$apellidos', correl='$correl',idrol='$rol', nombreusuario= '$nombreusuario',correo='$correo',password='$contra',fotor=0 WHERE idusuario='$id'");
				  if ($result ==1) {
		echo "   <script>
      swal({
