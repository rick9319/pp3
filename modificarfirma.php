...
<?php
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Firma Digital</h4>
 ...
 <?php
                                ...
                                ?>
                                   ...
                                   <div class="form-group row">
<div id="signArea" >
                                    <h2 class="tag-ingo">Ingrese la nueva firma digital</h2>
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        <input type="button" value="Ingresar firma" class="btn btn-info" name="ingresar" id="firma">
                                    </div>
                                </div>
    ...
    <script src="assets/libs/quill/dist/quill.min.js"></script>
      <script src="dist/bootstrap-select.js"></script>

    <link rel="stylesheet" href="dist/jquery-ui.css">
    <script src="dist/jquery-ui.js"></script>
    
    <link href="dist/jquery.signaturepad.css" rel="stylesheet">
    <script src="dist/numeric-1.2.6.min.js"></script> 
