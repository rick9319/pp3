...
$result = mysqli_query($link, "SELECT registro.nombreusuario, registro.correl, equipo.marca, equipo.modelo, equipo.nserie,aula.aula,tipo.nombre,procesoasig.cantidad,procesoasig.aprob from ((((procesoasig INNER JOIN registro ON registro.idusuario=procesoasig.idusuario) INNER JOIN equipo ON equipo.idequipo=procesoasig.idequipo) INNER JOIN tipo on equipo.idtipo=tipo.idtipo) INNER JOIN aula ON aula.idaula=procesoasig.idaula) WHERE procesoasig.idasig='$idasig'") or die(mysql_error());
        ...
        <div class="page-wrapper">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="consultaasig.php">Consulta salidas</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="actualizarasig.php" method="post">
                                <div class="card-body">
                                    <h4 class="card-title">Editar asignacion</h4>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nombre</label>
                                        <div class="col-sm-9">
                                            <input type="hidden" required="" value="<?php echo $idasig ?>" name="id" >
                                            <input type="text" class="form-control" id="fname" readonly="true" name="nombre" value="<?php echo $nombre ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Correlativo de empleado</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="lname" readonly="true" name="correl"value="<?php echo $correl ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Categoria</label>
                                        <div class="col-sm-9">
                                            <select class="select form-control custom-select" name="cat" style="width: 100%; height:36px;" onchange="onSelectChange();" disabled="true" >
                                                <?php $queryselectec=mysqli_query($link,"SELECT DISTINCT * FROM tipo");
            while($rowtec = mysqli_fetch_row($queryselectec))
            {
                if ($rowtec[0] == $tipo){
echo "<option selected value=";echo $rowtec[0]; echo">"; echo $rowtec[1]; echo "</option>";
                }
                else{
echo " <option value="; echo $rowtec[0]; echo ">"; echo $rowtec[1]; echo "</option>";
                }
                                }
                                        ?>
                                             </select>
                                    ...
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Marca</label>
                                        <div class="col-sm-9">
                                          <input type="text" class="form-control" id="email1" placeholder="Editar marca" required="" name="marca" value="<?php echo $marca ?>" readonly="true">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Modelo</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="email1" placeholder="Editar modelo" required="" name="modelo" value="<?php echo $modelo ?>" readonly="true">
                                        </div>
                                    </div>
                                      <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Numero de Serie</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="lname" required="" name="nserie" value="<?php echo $nserie ?>" readonly="true">
                                        </div>
                                    </div>
                                      <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Aula</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="lname" required="" name="aula" value="<?php echo $aula ?>" readonly="true">
                                        </div>
                                    </div>
                                      <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Cantidad</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="lname" required="" name="cantidad" value="<?php echo $cantidad ?>" readonly="true">
                                        </div>
                                    </div>
                                       <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Estado de aprobacion</label>
                                        <div class="col-sm-9">
                                            <select class="select form-control custom-select" name="apr" style="width: 100%; height:36px;" >
                                            <?php 
if($aprob == 0){
echo " <option selected value=0> No aprobado</option>" ;
echo " <option  value=2> Pendiente de aprobacion</option>" ;
echo " <option value=1> Aprobado</option>" ;
}
else if ($aprob == 1){
echo " <option selected value=1> Aprobado</option>" ;
echo " <option value=2> Pendiente de aprobacion</option>" ;
echo " <option value=0> No aprobado</option>" ;
}
else{
echo " <option selected value=2> Pendiente de aprobacion</option>" ;
echo " <option value=1> Aprobado</option>" ;
echo " <option value=0> No aprobado</option>" ;
}
