            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Encuesta de satisfacción</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="bienvenido.php">Inicio</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Encuesta de Satisfaccion</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <form id="example-form" action="insertarencuesta.php" class="m-t-40" method="POST">
                            <div>
                                ...
                                <section>
                                  <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                          ...
                                          <input type="checkbox"  value="1" name="btn">
                                           </label>
                                  Muy Malo
                               
                               <label class="btn btn-warning" >
                                          <input type="checkbox"  value="2" name="btn">
                                           </label>
                                 Malo
                              
                                <label class="btn btn-primary" >
                                          <input type="checkbox"  value="3" name="btn">
                                           </label>
                                Regular
                        
                                <label class="btn btn-info" >
                                          <input type="checkbox"  value="4" name="btn">
                                           </label>
                                 Bueno
                            
                                 <label class="btn btn-success">
                                          <input type="checkbox"  value="5" name="btn">
                                           </label>
                                 Muy bueno
                                  </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                          ...
                                          <input type="checkbox"  value="Sociales" name="btn2" >
                                          Sociales
                                           </label>
                                    <label class="btn btn-outline-secondary">
                                          <input type="checkbox"  value="Ingenieria" name="btn2">
                                          Ingenieria
                                           </label>
                                <label class="btn btn-outline-secondary">
                                          <input type="checkbox"  value="Juridica" name="btn2">
                                         Juridica
                                           </label>
                              <label class="btn btn-outline-secondary">
                                          <input type="checkbox"  value="Empresarial" name="btn2">
                                        Empresarial
                                           </label>
                             <label class="btn btn-outline-secondary">
                                          <input type="checkbox"  value="Medicina" name="btn2">
                                       Medicina
                                           </label>
                                           <label class="btn btn-outline-secondary">
                                          <input type="checkbox"  value="Mantenimiento" name="btn2">
                                       Mantenimiento
                                           </label>
                                        </div>
                                    </div>
                             ...
                             <label class="btn btn-outline-info">
                                          <input type="checkbox"  value="18-25" name="btn3">
                                      18-25
                                           </label>
                                   <label class="btn btn-outline-info">
                                          <input type="checkbox"  value="25-30" name="btn3">
                                      25-30
                                           </label>
                                 <label class="btn btn-outline-info">
                                          <input type="checkbox"  value="30-50" name="btn3">
                                   30-50
                                           </label>
                                   <label class="btn btn-outline-info">
                                          <input type="checkbox"  value="50-70" name="btn3">
                                   50-70
                                           </label>
                                   <label class="btn btn-outline-info">
                                          <input type="checkbox"  value="70 o mas" name="btn3">
                                  70 o mas
                                           </label>
                                       </div>
                                    </div>
                                    <div class="form-group row">
                                         <label for="lname" class="col-sm-3 text-right control-label col-form-label">¿Considera necesaria la implementacion de una aplicacion web para el control de inventario y asignacion de equipos?</label>
                                          <div class="col-sm-9">
                                <label class="btn btn-success" >
                                          <input type="checkbox"  value="Si" name="btn4">
                                          Si
                                          </label>
                                                             
                                <label class="btn btn-danger" >
                                          <input type="checkbox"  value="No" name="btn4">
                                          No
                                          </label>
